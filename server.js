...
app.post("/api/room", rl, (req, res) => {
  ...
  const room = roomEngine.create({ hostId: b.playerId, name: b.name, setCode: b.setCode, setName: b.setName, lang: b.lang, alcoholFree: b.alcoholFree, avatar: b.avatar, premium: b.premium, jokers: b.jokers });
